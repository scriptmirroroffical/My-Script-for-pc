...
_STORAGE["Loading"] = Loading
Loading.Name = "Loading"
Loading.Parent = game:GetService('Players').LocalPlayer:WaitForChild('PlayerGui')

local Main = Instance.new("Frame")
_STORAGE["Main"] = Main
Main.Name = "Main"
Main.Size = UDim2.new(0.25, 0, 0.22, 0) 
Main.Position = UDim2.new(0.393, 0, 0.396, 0)
Main.BackgroundColor3 = Color3.fromRGB(255, 157, 37)
Main.BackgroundTransparency = 0
Main.Visible = true
Main.ZIndex = 1
Main.BorderSizePixel = 0
Main.ClipsDescendants = false
Main.Parent = _STORAGE["Loading"] or Loading

local UICorner = Instance.new("UICorner")
_STORAGE["UICorner"] = UICorner
UICorner.Name = "UICorner"
UICorner.Parent = _STORAGE["Main"] or Main

local Name = Instance.new("TextLabel")
_STORAGE["Name"] = Name
Name.Name = "Name"
Name.Size = UDim2.new(0.525, 0, 0.207, 0)
Name.Position = UDim2.new(0.092, 0, 0.155, 0)
Name.Text = "SM Executor"
Name.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Name.BackgroundTransparency = 1.0099999904632568
Name.TextTransparency = 0
Name.Visible = true
Name.ZIndex = 1
Name.FontFace = Font.new("rbxasset://fonts/families/IndieFlower.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
...
Name.Parent = _STORAGE["Main"] or Main

local UIStroke = Instance.new("UIStroke")
_STORAGE["UIStroke"] = UIStroke
UIStroke.Name = "UIStroke"
UIStroke.ZIndex = 1
UIStroke.Parent = _STORAGE["Name"] or Name

local UIStroke_2 = Instance.new("UIStroke")
_STORAGE["UIStroke_2"] = UIStroke_2
UIStroke_2.Name = "UIStroke"
UIStroke_2.ZIndex = 1
UIStroke_2.Parent = _STORAGE["Main"] or Main

local BeautiUI = Instance.new("Frame")
_STORAGE["BeautiUI"] = BeautiUI
BeautiUI.Name = "BeautiUI"
BeautiUI.Size = UDim2.new(0.282, 0, 0.987, 0)
BeautiUI.Position = UDim2.new(0.717, 0, 0, 0)
BeautiUI.BackgroundColor3 = Color3.fromRGB(255, 196, 79)
BeautiUI.BackgroundTransparency = 0
BeautiUI.Visible = true
BeautiUI.ZIndex = 1
BeautiUI.BorderSizePixel = 0
BeautiUI.ClipsDescendants = false
BeautiUI.Parent = _STORAGE["Main"] or Main

local UICorner_2 = Instance.new("UICorner")
_STORAGE["UICorner_2"] = UICorner_2
UICorner_2.Name = "UICorner"
UICorner_2.Parent = _STORAGE["BeautiUI"] or BeautiUI

local UIStroke_3 = Instance.new("UIStroke")
_STORAGE["UIStroke_3"] = UIStroke_3
UIStroke_3.Name = "UIStroke"
UIStroke_3.ZIndex = 1
UIStroke_3.Parent = _STORAGE["BeautiUI"] or BeautiUI

local BeautiUI_2 = Instance.new("Frame")
_STORAGE["BeautiUI_2"] = BeautiUI_2
BeautiUI_2.Name = "BeautiUI"
BeautiUI_2.Size = UDim2.new(0, 313, 0, 88)
BeautiUI_2.Size = UDim2.new(0.645, 0, 0.365, 0)
BeautiUI_2.Position = UDim2.new(0.354, 0, 0.630, 0)
BeautiUI_2.BackgroundColor3 = Color3.fromRGB(255, 196, 79)
BeautiUI_2.BackgroundTransparency = 0
BeautiUI_2.Visible = true
BeautiUI_2.ZIndex = 1
BeautiUI_2.BorderSizePixel = 0
BeautiUI_2.ClipsDescendants = false
BeautiUI_2.Parent = _STORAGE["Main"] or Main

local UICorner_3 = Instance.new("UICorner")
_STORAGE["UICorner_3"] = UICorner_3
UICorner_3.Name = "UICorner"
UICorner_3.Parent = _STORAGE["BeautiUI_2"] or BeautiUI_2

local UIStroke_4 = Instance.new("UIStroke")
_STORAGE["UIStroke_4"] = UIStroke_4
UIStroke_4.Name = "UIStroke"
UIStroke_4.ZIndex = 1
UIStroke_4.Parent = _STORAGE["BeautiUI_2"] or BeautiUI_2

local BeautiUI_3 = Instance.new("Frame")
_STORAGE["BeautiUI_3"] = BeautiUI_3
BeautiUI_3.Name = "BeautiUI"
BeautiUI_3.Size = UDim2.new(0.282, 0, 0.307, 0)
BeautiUI_3.Position = UDim2.new(0.717, 0, 0.495, 0)
BeautiUI_3.BackgroundColor3 = Color3.fromRGB(255, 196, 79)
BeautiUI_3.BackgroundTransparency = 0
BeautiUI_3.Visible = true
BeautiUI_3.ZIndex = 1
BeautiUI_3.BorderSizePixel = 0
BeautiUI_3.ClipsDescendants = false
BeautiUI_3.Parent = _STORAGE["Main"] or Main

local LoadingBar = Instance.new("Frame")
_STORAGE["LoadingBar"] = LoadingBar
LoadingBar.Name = "LoadingBar"
LoadingBar.Size = UDim2.new(0.548, 0, 0.066, 0)
LoadingBar.Position = UDim2.new(0.092, 0, 0.777, 0)
LoadingBar.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
LoadingBar.BackgroundTransparency = 0
LoadingBar.Visible = true
LoadingBar.ZIndex = 1
LoadingBar.BorderSizePixel = 0
LoadingBar.ClipsDescendants = false
LoadingBar.Parent = _STORAGE["Main"] or Main

local UICorner_4 = Instance.new("UICorner")
_STORAGE["UICorner_4"] = UICorner_4
UICorner_4.Name = "UICorner"
UICorner_4.Parent = _STORAGE["LoadingBar"] or LoadingBar

local LoadingProgress = Instance.new("Frame")
_STORAGE["LoadingProgress"] = LoadingProgress
LoadingProgress.Name = "LoadingProgress"
LoadingProgress.Size = UDim2.new(0, 0, 1, 0)
LoadingProgress.Position = UDim2.new(0, 0, 0, 0)
LoadingProgress.BackgroundColor3 = Color3.fromRGB(0, 170, 255)
LoadingProgress.BackgroundTransparency = 0
LoadingProgress.Visible = true
LoadingProgress.ZIndex = 1
LoadingProgress.BorderSizePixel = 0
LoadingProgress.ClipsDescendants = false
LoadingProgress.Parent = _STORAGE["LoadingBar"] or LoadingBar

local UICorner_5 = Instance.new("UICorner")
_STORAGE["UICorner_5"] = UICorner_5
UICorner_5.Name = "UICorner"
UICorner_5.Parent = _STORAGE["LoadingProgress"] or LoadingProgress

local LoadingContent = Instance.new("TextLabel")
_STORAGE["LoadingContent"] = LoadingContent
LoadingContent.Name = "LoadingContent"
LoadingContent.Size = UDim2.new(0.548, 0, 0.12, 0)
LoadingContent.Position = UDim2.new(0.092, 0, 0.630, 0)
LoadingContent.Text = "Waiting..."
LoadingContent.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
LoadingContent.BackgroundTransparency = 1
LoadingContent.TextTransparency = 0
LoadingContent.Visible = true
LoadingContent.ZIndex = 1
LoadingContent.FontFace = Font.new("rbxasset://fonts/families/Guru.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
LoadingContent.Font = Enum.Font.Garamond
LoadingContent.TextScaled = true
LoadingContent.TextSize = 14
LoadingContent.TextColor3 = Color3.fromRGB(0, 0, 0)
LoadingContent.BorderSizePixel = 0
LoadingContent.TextXAlignment = Enum.TextXAlignment.Center
LoadingContent.TextYAlignment = Enum.TextYAlignment.Center
LoadingContent.TextWrapped = true
LoadingContent.ClipsDescendants = false
LoadingContent.Parent = _STORAGE["Main"] or Main

_G.OmniStorage = _STORAGE

-- ==========================================
-- [OMNI-GOD CORE LOGIC]
-- Dán đoạn này vào cuối script GUI của bạn
-- ==========================================
local TweenService = game:GetService("TweenService")
local Players = game:GetService("Players")
local LocalPlayer = Players.LocalPlayer

-- Lấy GUI elements từ _STORAGE
local LoadingContent = _STORAGE["LoadingContent"]
local LoadingProgress = _STORAGE["LoadingProgress"]
local MainFrame = _STORAGE["Main"]

-- Hàm cập nhật thanh tiến trình mượt mà
...
local function CloseUI()
	local MainFrame = _STORAGE["Main"]
	local LoadingGui = _STORAGE["Loading"]

	if MainFrame then
		-- Tween thu nhỏ và làm mờ dần
	...
	if LoadingGui then
		LoadingContent.Text = "Warning: LoadingUI not close Detected!"
		LoadingContent.Text = "Force closing..."
		task.wait(2)
		LoadingGui:Destroy()
	end
end

-- Khởi chạy chuỗi Core Logic
task.spawn(function()
	-- 1. Loading Environment & Kiểm tra quyền thực thi
	UpdateProgress(0.20, "Loading Environment...", 1.5)

	local executorName = (identifyexecutor and identifyexecutor()) or "Unknown Executor"
	-- Kiểm tra quyền: nếu executor local không đủ hàm bypass/hook thì chạy tiếp sẽ dễ lỗi hoặc vô dụng
	local hasPrivileges = (getgenv and hookmetamethod and getnamecallmethod and checkcaller) ~= nil

	if not hasPrivileges then
		UpdateProgress(0.35, "Warning: Low Level Executor Detected!", 1.5)
	else
		UpdateProgress(0.35, "Environment Verified: " .. executorName, 1)
	end

	-- 2. Detecting Anti-cheat (Check Local)
	UpdateProgress(0.60, "Detecting Anti-cheat...", 2)
	...
	if LocalPlayer:FindFirstChild("PlayerScripts") then
		for _, v in pairs(LocalPlayer.PlayerScripts:GetDescendants()) do
			if v:IsA("LocalScript") then
				...
				if string.find(name, "ac") or string.find(name, "cheat") or string.find(name, "detect") or string.find(name, "ban") then
					acFound = true
					break
				end
			end
	...
	if acFound then
		UpdateProgress(0.75, "Anti-cheat Detected! Preparing bypass...", 1.2)
	else
		UpdateProgress(0.75, "No Local Anti-cheat found.", 1)
	end

	-- 3. Bypassing (Chặn Client Kick qua Namecall)
	UpdateProgress(0.90, "Bypassing...", 1.5)

	if hasPrivileges then
		local OldNamecall
		OldNamecall = hookmetamethod(game, "__namecall", function(self, ...)
			local method = getnamecallmethod()
			-- Block các lệnh Kick xuất phát từ Client (Anti-cheat local)
			if not checkcaller() and (method == "Kick" or method == "kick") and self == LocalPlayer then
				return nil 
			end
			return OldNamecall(self, ...)
		end)
		UpdateProgress(0.95, "Bypass Active: Anti-Kick Hooked", 1)
	end

	-- 4. Hoàn tất & Chuyển giao
	UpdateProgress(1, "Ready!", 0.5)
	task.wait(0.5)

	if LoadingContent then
		LoadingContent.Text = "Waiting for Executor Core..."
	end
	-- [OMNI-GOD CORE GENERATED]
	-- Author: son171020
	-- Mode: Smart Relay (_G.OmniStorage)
